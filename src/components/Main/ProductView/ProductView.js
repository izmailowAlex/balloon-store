  ...
  return (
    <div className="product-view">
      <div className="product-view__image-container">
        <img className="product-view__image" src="../../images/cat-full.png" alt="Cat"/>
      </div>
      <div className="product-view__content">
        <h2 className="product-view__title">{currentProduct.title}</h2>
        <span className="product-view__tag product-view__tag_instock">{currentProduct.instock}</span>
        <div className="product-view__price">
          <span className="product-view__current-price">{currentProduct.price}</span>
          <span className="product-view__old-price">{currentProduct.oldPrice}</span>
        </div>
        <div className="product-view__control-group">
          <span className="product-view__quantity"><Counter count={currentProduct.count} min={1} max={100}/></span>
          <Button className="product-view__to-cart-button" button={true}>В корзину</Button>
        </div>
        <div className="product-view__description">
          <div className="product-view__description-title">{currentProduct.text}</div>
